...
public class Content extends BaseModel {
    ...
    @OneToMany(targetEntity= com.team5.ACMEFlix.domain.Genre.class, fetch = FetchType.LAZY, mappedBy = "content", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<com.team5.ACMEFlix.domain.Genre> genres;

    @JsonManagedReference
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    @OneToMany(targetEntity= com.team5.ACMEFlix.domain.Actor.class, fetch = FetchType.LAZY, mappedBy = "content", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<com.team5.ACMEFlix.domain.Actor> actors;
